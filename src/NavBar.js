        ...
        <Container>
            <div className="container mx-auto text-white flex justify-between">
                <nav className="flex">
                    ...
                    <NavLink to="/youtube" activeClassName="text-white md:focus:underline" className="inline-flex items-center py-2 px-8  my-0  text-white hover:text-red-400 text-lg cursive ">
                        YouTube
                    </NavLink>
                    <NavLink to="/project" activeClassName="text-white md:focus:underline" className="inline-flex items-center py-2 px-8 my-0  text-white hover:text-blue-400 text-lg cursive">
                        Projects
                    </NavLink>
                    <NavLink to="/about" activeClassName="text-white md:focus:underline" className="inline-flex items-center py-2 px-8 my-0  text-white hover:text-yellow-400 text-lg cursive">
                        About Me
                    </NavLink>
